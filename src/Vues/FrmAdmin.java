...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    private void tblUsersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsersMouseClicked
        User User1 = new User(1, "Dupont", "Jean","Mineur");
        User User2 = new User(2, "Poutou", "Philippe","Majeur");
        User User3 = new User(3, "Macron", "Emmanuel","Terminé");
        User User4 = new User(4, "Zemmour", "Eric","Mineur");
        User User5 = new User(5, "Hollande", "François","Terminé");
